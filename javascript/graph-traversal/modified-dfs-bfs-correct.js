...
Graph.prototype.iterativeDepthFirstSearch = function (root) {
  if (!root) return;
  var stack = [];
  stack.push(root);
...
var graphBFS = setupTest();
console.log('START ITERATIVE DEPTH FIRST SEARCH');
graphBFS.iterativeDepthFirstSearch(graphBFS.nodes[0]);
